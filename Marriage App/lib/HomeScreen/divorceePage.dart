...
class DivorceePage extends StatefulWidget {
  DivorceePage({this.gender});
  final String gender;
  @override
  _DivorceePageState createState() => _DivorceePageState();
}

class _DivorceePageState extends State<DivorceePage> {
  @override
  ...
  getListView() {
    ...
    return StreamBuilder(
      stream: Firestore.instance.collection("users").where("gender",isEqualTo: widget.gender).where("personType",isEqualTo: "divorcee").snapshots(),
      builder: ( bc, snapshot){
        if(!snapshot.hasData){
